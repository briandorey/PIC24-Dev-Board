...
void UART1_InitializeDebugPort(void) {
    // RTSMD disabled; URXINV disabled; BRGH enabled; STSEL 1; UARTEN enabled; PDSEL 8N; LPBACK disabled; WAKE disabled; USIDL disabled; ABAUD disabled; IREN disabled; UEN TX_RX; 
    U1MODE = 0x8008;
...
/**
void DRV_UART1_InitializeDebugPort (void)
 */
void DRV_UART1_InitializeDebugPort(void) {
